...
root_agent = Agent(
    ...
    instruction="""You are a research assistant that helps users find accurate, up to date information.
    Your approach:
    ...
    4. If search results are insufficent, acknowledge limitations
